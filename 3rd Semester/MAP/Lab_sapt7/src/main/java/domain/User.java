...
public abstract class User implements Observer {
    ...
    @Override
    public void update(Event event, String mesaj) {
        System.out.println(this.getUsername() + "cu id-ul :" + this.getId() + " a primit notificare de la event-ul " + event.getNume() + ": " + mesaj);
    }
}
