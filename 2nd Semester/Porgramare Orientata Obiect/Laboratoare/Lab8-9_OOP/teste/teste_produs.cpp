...
void TesteProdus::test_operatorEqual() {
    Produs produs1("Phone", 3500, "Mobile", "Samsung", 123);
    Produs produs2("Laptop", 5000, "Electronics", "Dell", 123);  // same ID
    Produs produs3("Tablet", 1500, "Mobile", "Apple", 456);      // different ID

    assert(produs1 == produs2);
    assert(!(produs1 == produs3));
}
